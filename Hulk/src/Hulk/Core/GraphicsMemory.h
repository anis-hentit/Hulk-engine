...
namespace DirectX
{
    class HULK_API LinearAllocatorPage;
    ...
    class HULK_API GraphicsResource
    {
    public:
    ...
    class HULK_API SharedGraphicsResource
    {
    public:
    ...
    //----------------------------------------------------------------------------------
    struct HULK_API GraphicsMemoryStatistics
    {
