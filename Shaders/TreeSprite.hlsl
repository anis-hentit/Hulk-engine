...
//the maximum number of vertices we output per geometry shader invocation is 4.
[maxvertexcount(4)]
...
// Transform quad vertices to clip space and output
...
{
	// thrid component will just act as an index into the text array
